...
This extension is built on [Banana Codex](https://github.com/AgriciDaniel/banana-codex),
...
```bash
python3 ./skills/seo-image-gen/scripts/presets.py list
```
...
- Log every generation: `python3 ./skills/seo-image-gen/scripts/cost_tracker.py log --model MODEL --resolution RES --prompt "brief"`
...
| MCP unavailable | Fall back: `python3 ./skills/seo-image-gen/scripts/generate.py --prompt "..." --aspect-ratio "16:9"` |
